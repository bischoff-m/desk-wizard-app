import { AnimationSettings, DisplayTimings, ScreenInfo, Size } from "../../types";
...
export class ProgramState {
  ...
  constructor(public screens: ScreenInfo[], public animationSettings: AnimationSettings) {
  ...
  private requestFrame(time?: DOMHighResTimeStamp): void {
    ...
    if (this.missedFrameFlag) {
      ...
      if (time - this.time > (1000 / this.animationSettings.fps!) * 3) this.time = time;
      return;
    }
